...
let SecurityBox = class SecurityBox extends typeorm_1.BaseEntity {
};
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_model_1.User, (user) => user.securityBoxes),
...
__decorate([
    ...
    __metadata("design:type", credentialStorage_model_1.CredentialStorage)
